...
#define ex_camera_set_scroll_easing
...
with(_camera) {
    ...
    _scroll_easing = argument[1];

}


#define ex_camera_set_fade_easing
...
with(_camera) {
    ...
    _fade_easing = argument[1];

}


#define ex_camera_set_flash_easing
...
with(_camera) {
    ...
    _flash_easing = argument[1];

}


#define ex_camera_set_tilt_easing
...
with(_camera) {
    ...
    _tilt_easing = argument[1];

}


#define ex_camera_set_zoom_easing
...
with(_camera) {
    ...
    _zoom_easing = argument[1];

}


#define ex_camera_set_shake_easing
...
with(_camera) {
    ...
    _shake_easing = argument[1];

}


#define ex_camera_set_easing
...
with(_camera) {
	...
	view_xview[_view] = argument[1];
	view_yview[_view] = argument[2];
	view_xport[_view] = argument[1];
	view_yport[_view] = argument[2];
	
	view_wview[_view] = argument[3];
	view_hview[_view] = argument[4];
	view_wport[_view] = argument[3];
	view_hport[_view] = argument[4];
...
with(_camera) {
	...
	_bound_x 		= argument[1];
	_bound_y 		= argument[2];
	_bound_width 	= argument[3];
	_bound_height 	= argument[4];

}

#define ex_camera_reset_bounds
